...
static bool saveAs() {
    ...
    while (true) {
        ...
        // ---------------------------------------------------------
        // Don't use Ctrl/Alt combinations as text
        // ---------------------------------------------------------
...
static void ctrlDelete() {
    ...
    while (
        target < static_cast<int>(line.size()) &&
...
static Position screenToDocument(
    COORD mouse
) {
...
static void drawHelp() {
    ...
    addKey(
        L"PAGE UP",
        L"Scroll one page upward"
    );

    addKey(
        L"PAGE DOWN",
        L"Scroll one page downward"
    );
    ...
    addKey(
        L"BACKSPACE",
        L"Delete previous character"
    );

    addKey(
        L"DELETE",
        L"Delete next character"
    );

    addKey(
        L"CTRL+BACKSPACE",
        L"Delete previous word"
    );
    ...
    addKey(
        L"CTRL+A",
        L"Select entire document"
    );

    addKey(
        L"MOUSE DRAG",
        L"Select a range of text"
    );
    ...
    addKey(
        L"UP / DOWN",
        L"Scroll this help screen"
    );

    addKey(
        L"PAGE UP / DOWN",
        L"Scroll by one page"
    );
